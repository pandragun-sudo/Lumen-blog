...
description: "쇼츠 제목에 작품명을 넣지 않아도 검색 유입 1위를 기록하는 이유와, 피드 클릭률과 검색 롱테일을 모두 잡는 실전 카피라이팅 방식을 실측 스튜디오 데이터로 분석합니다."
category: "guide"
...
실제로 제가 운영하는 자체 운영 채널과 루멘 인사이트 분석 데이터를 들여다보면 흥미로운 공통점이 있습니다. **피드에서 수백만 뷰가 터진 쇼츠일수록, 제목과 실제 유입되는 검색 키워드가 전혀 딴판인 경우가 많습니다.**
...
자체 운영 채널에 올렸던 영화 리뷰 쇼츠 중 *"[Case A] 캐릭터 명대사 코믹 쇼츠 (43초)"*이라는 영상이 있습니다.
...
제목에 영화 이름을 단 한 자도 넣지 않았음에도 이런 검색 유입이 가능한 이유는, 유튜브 알고리즘이 영상의 음성과 자막, 그리고 뒤에 붙은 해시태그로 이미 이 영상이 어떤 작품을 다루고 있는지 스스로 이해하고 색인(Indexing)하기 때문입니다. 
굳이 피드 클릭률을 깎아먹으면서까지 제목 앞부분에 딱딱한 고유명사를 채워 넣지 않아도 무방하다는 뜻입니다.

## 상황 설명은 제목 앞에, 고유명사는 해시태그 뒤로 넘기는 분리법

그렇다면 피드 클릭과 검색 유입을 둘 다 잡으려면 제목을 어떻게 구성해야 할까요? 제가 다음으로 시도했던 *"[Case C] 코믹 액션 영화 쇼츠 (33초)"* 영상의 데이터를 보면 그 답이 명확해집니다.
...
* **'극한직업' (8.0%)**: 제목 앞부분에 배치한 공감형 밈 키워드로 대규모 트래픽이 유입되었습니다.
* **'원작작품명 키워드' (3.5%), '관련 시리즈명' (2.3%)**: 제목 맨 뒤 해시태그에 넣어둔 실제 작품명이 검색 엔진에 정확히 걸려들었습니다.

| 위치 | 실제 텍스트 | 역할 및 노림수 |
|---|---|---|
| 제목 앞단 (1~15자) | "[Case C] 코믹 액션 영화 쇼츠 (33초)" | 피드에서 3초 안에 눈길을 사로잡고 상황에 공감하게 만듦 |
| 제목 뒷단 해시태그 | "#원작작품명 #장르태그" | 유튜브 검색 알고리즘에 영상의 정확한 주제 및 원작명 전달 |
