...
description: "3주간 업로드가 멈춰 조회수가 바닥을 쳤던 자체 운영 채널이 3개 쇼츠로 386만 뷰를 기록하며 V자 반등에 성공한 실제 유튜브 스튜디오 데이터와 70% 이탈 방어선, 110%+ 루프 시청 설계 공식을 심층 분석합니다."
...
연구소 자체 운영 쇼츠 채널에서 약 3주간의 업로드 중단으로 일일 조회수가 0에 가깝게 정체되었던 상태에서, 연속으로 발행한 3개의 쇼츠 콘텐츠만으로 28일 누적 386만 뷰(3,868,295회)를 달성하며 완벽한 V자 급반등을 이뤄낸 실제 유튜브 스튜디오 데이터를 공개하고 그 핵심 구조를 분석합니다.

---

## 3주간의 공백과 극적인 V자 반등 그래프

아래 대시보드는 자체 운영 채널의 최근 28일간 전체 채널 통계 지표입니다.

![386만 뷰를 달성한 자체 운영 채널의 유튜브 스튜디오 V자 급반등 그래프](../../assets/blog/SCR-20260901-teyb.png)
...
| :--- | :---: | :---: | :---: | :---: |
| [Case 1] 삼촌과 조카 감동 드라마 쇼츠 (31초) | 102.4만 회 | 114.5% (0:35) | 71.3% | 40.5만 명 |
| [Case 2] 일상 코믹 티키타카 쇼츠 (42초) | 99.0만 회 | 111.8% (0:46) | 71.8% | 41.0만 명 |
| [Case 3] 세대 공감 유머 쇼츠 (37초) | 64.9만 회 | 111.4% (0:41) | 77.9% | 29.1만 명 |
...
### 1. 77.9%의 잔존율: [Case 3] 세대 공감 유머 쇼츠 (37초)

![[Case 3] 세대 공감 유머 쇼츠 (37초) 쇼츠의 77.9% 시청 유지율 스크린샷](../../assets/blog/SCR-20260901-tfko.png)
...
### 2. 71.3%의 방어선: [Case 1] 삼촌과 조카 감동 드라마 쇼츠 (31초)

![[Case 1] 삼촌과 조카 감동 드라마 쇼츠 (31초) 쇼츠의 71.3% 유지율 스크린샷](../../assets/blog/SCR-20260901-tfpr.png)
...
### 3. 71.8%의 지지선: [Case 2] 일상 코믹 티키타카 쇼츠 (42초)

![[Case 2] 일상 코믹 티키타카 쇼츠 (42초) 쇼츠의 71.8% 유지율 스크린샷](../../assets/blog/SCR-20260901-tfue.png)
...
```mermaid
flowchart LR
    A["0초 도입부 Hook<br/>강렬한 갈등 상황 제시"] --> B["15초 전개<br/>궁금증 유발 & 핵심 결말 지연"]
...
### 1. 102.4만 뷰 달성: 114.5% AVD ([Case 1] 삼촌과 조카 감동 드라마 쇼츠 (31초))

![102만 뷰와 114.5% 평균 조회율 스크린샷](../../assets/blog/SCR-20260901-tfee-v2.png)
...
### 2. 99만 뷰 달성: 111.8% AVD ([Case 2] 일상 코믹 티키타카 쇼츠 (42초))

![99만 뷰와 111.8% 평균 조회율 스크린샷](../../assets/blog/SCR-20260901-tfcn-v2.png)
...
### 3. 64.9만 뷰 달성: 111.4% AVD ([Case 3] 세대 공감 유머 쇼츠 (37초))

![64만 뷰와 111.4% 평균 조회율 스크린샷](../../assets/blog/SCR-20260901-tfft-v2.png)
