...
**초기 3초의 오프닝 훅 품질**이 핵심입니다. 피크 타임에 올렸더라도 오프닝 훅이 약하면 알고리즘이 1단계 배포 이후 확장을 멈춥니다. 1MIN DRAMA 채널의 운영 데이터에서, 동일한 피크 타임에 올린 영상들 중 오프닝 훅이 강한 영상(스와이프 이탈률 30% 미만)은 약한 영상(55% 이상)에 비해 최종 조회수가 최대 8배 이상 차이를 보였습니다.
