...
**채널 퍼포먼스(Channel Performance)**는 크리에이터가 오롯이 통제할 수 있는 실행 영역입니다. 썸네일 클릭률(CTR), 3초 피드 유지율, 평균 시청 지속 시간(AVD), 그리고 영상 전반의 몰입감이 여기에 해당합니다. 앞선 두 가지 파도가 준비되었을 때 비로소 이 채널 퍼포먼스가 결합되어 폭발적인 도약이 완성됩니다.
